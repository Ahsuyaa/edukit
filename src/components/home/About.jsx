        ...
        <div className="grid md:grid-cols-2 gap-2 lg:gap-4 ">
          <div className="text-white my-10 md:my-24 mx-5 ">
            ...
            {lists ? (
              ...
              <svg aria-hidden="true" className="inline w-30 h-24 mr-2  text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="object-cover ">
            {lists ? (
                ...
                <img
                  ...
                  src={`https://pdeng.valleyhomecareservice.com/storage/${lists.data.about.image.url}`}
                />
